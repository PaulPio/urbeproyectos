...
//Programa para llevar inventario con funciones
	...
	public void compras(double[] lista_can, double[] lista_preUSD, double[] lista_preVES, int[] lista_cod, String[] lista_prod){
		...
		do {
			...
			System.out.print("Ingrese el numero del producto que desee llevar.");
			...
			double[] factura = {cantidad * lista_preVES[num_producto], cantidad * lista_preUSD[num_producto]};
			
			//Para imprimir la factura
			System.out.println("El monto de la factura del cliente "+ tf.lista_clientes_nombre[tf.contador_cli_nombre - 1]+ " " + tf.lista_clientes_apellido[tf.contador_cli_apellido - 1] + " es: \nEn VES: "+ factura[0]+ "\nEn USD: "+ factura[1]);
			vida = false;
